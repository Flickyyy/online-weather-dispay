...
Список городов, частота обновления, количество дней прогноза определены в конфиге. Конфиг в формате json. Взаимодействие с ним происходит с
помощью nlohman-json.
...
В ходе работы программы обрабатываются разные самые частовозникающие ошибки (сервер не отвечает, к примеру).